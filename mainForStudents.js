...
// console.log(student[0] === copyStudents[0] ) - что должно быть в консоли?true
...
let topStudents =deepCopyStudents.sort((a,b)=>a.scores <= b.scores ?1:-1) ;
//console.log(topStudents)
// topStudents = topStudents.splice(0, 3)
//  console.log(topStudents)
// console.log(deepCopyStudents)
...
// let bestStudent = students.reduce((max, next)=>{
//     return max.scores > next.scores ? max :next
// });
...
// let scoresSum = students.reduce((prev, current)=>{
//     return prev + current.scores
// },0)
...
const addFriends = (students) => {
   for (let i=0; i<students.length; i++){
       let copyStudents = [...students.map(m=>({...m}))]
       copyStudents.splice(i,1)
       students[i].friends = copyStudents
   }
   return students
}
